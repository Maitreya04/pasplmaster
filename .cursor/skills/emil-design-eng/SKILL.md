...
description: Applies Emil Kowalski's design-engineering philosophy to UI polish, animation decisions, easing, micro-interactions, and component craft. Use when building or reviewing interfaces, CSS transitions, popovers, motion, Framer Motion, or when the user wants tasteful UI details and invisible correctness.
---
