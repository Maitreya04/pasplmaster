...
export default function BillingDeskPage(): React.JSX.Element {
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex flex-col flex-1 min-h-0 h-full overflow-hidden p-4 lg:p-6">
        <div className="desk-panel relative flex flex-col flex-1 min-h-0 h-full rounded-xl border border-[var(--border-subtle)] overflow-hidden bg-[var(--bg-primary)]">
          <DeskSplitPane
