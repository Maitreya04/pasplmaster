-- Defense in depth: never send orders with zero pickable lines to warehouse_pick.
...
COMMENT ON FUNCTION public.complete_billing(BIGINT, BIGINT, BIGINT, BOOLEAN, TEXT) IS
  'Complete billing claim. Auto-downgrades warehouse_pick to direct_bill when order_has_pickable_lines is false.';
