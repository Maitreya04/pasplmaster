-- Fix PL/pgSQL name clash: loop variable r shadowed resolve_sales_order_customer alias.
-- Error surfaced as: record "r" is not assigned yet
...
BEGIN
  BEGIN
    ...
    FROM public.resolve_sales_order_customer(v_customer_id, v_customer_name, v_customer_city)
    LIMIT 1;
